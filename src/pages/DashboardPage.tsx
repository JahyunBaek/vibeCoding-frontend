...
const bmiScatter = [
  { age: 25, bmi: 22.1, group: "A" },
  { age: 28, bmi: 24.3, group: "A" },
  { age: 32, bmi: 26.8, group: "B" },
  { age: 35, bmi: 27.2, group: "B" },
  { age: 38, bmi: 28.5, group: "B" },
  { age: 40, bmi: 25.1, group: "A" },
  { age: 43, bmi: 29.7, group: "C" },
  { age: 46, bmi: 30.2, group: "C" },
  { age: 50, bmi: 27.9, group: "B" },
  { age: 53, bmi: 31.4, group: "C" },
  { age: 56, bmi: 24.6, group: "A" },
  { age: 60, bmi: 28.8, group: "B" },
  { age: 63, bmi: 26.3, group: "A" },
  { age: 67, bmi: 32.1, group: "C" },
  { age: 70, bmi: 23.9, group: "A" },
  { age: 74, bmi: 29.5, group: "B" },
];
    ...
    <div className="space-y-6">
            ...
            <CardContent className="pt-5">
              <div className="flex items-start justify-between">
                <div>
                  ...
                  <div
                    className={`mt-1 flex items-center gap-1 text-xs font-medium ${k.up ? "text-emerald-600" : "text-rose-500"}`}
                  >
      ...
      <div className="grid gap-4 xl:grid-cols-3">
        ...
        <Card className="xl:col-span-1">
          <CardHeader>
            <CardTitle className="flex items-center gap-2">
              <Dna className="h-4 w-4 text-violet-500" />간 효소 수치 추이
            </CardTitle>
        ...
        <Card className="xl:col-span-1">
          <CardHeader>
            ...
            <CardDescription>
              전체 등록 환자 {conditionPie.reduce((s, d) => s + d.value, 0).toLocaleString()}명
            </CardDescription>
          </CardHeader>
          <CardContent>
                    ...
                    <div className="flex items-center gap-2">
                      <div className="h-2 flex-1 overflow-hidden rounded-full bg-accent">
                        <div
                          ...
                          style={{
                            width: `${pct}%`,
                            background: pct >= 100 ? C.emerald : t.status === "중단" ? C.rose : C.blue,
                          }}
                        />
                      </div>
